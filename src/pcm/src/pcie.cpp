...
int main(int argc, char * argv[])
{
    ...
    cout<<"class name: "<<typeid(platform).name()<<endl<<endl;
    ...
    vector<eventGroup_t> *eventGroups = platform->getEventGroups();
    ...
    mainLoop([&]()
    {
        ...
        // cout<<"eventGroups: "<<eventGroups<<endl;
        // for (auto &ep : *eventGroups){
        //     for (auto x: ep)
        //         cout<<"opcodes: "<< &x <<endl;
        // }

        for (auto &evGroup : *eventGroups){
            m->programPCIeEventGroup(evGroup);
            platform->getEventGroup(evGroup, 0);
        }
        ...
        for (auto &evGroup : *eventGroups){
            ...
            platform->getEventGroup(evGroup, 1);
        }

        // platform->getEvents(0);
        // // MySleepMs(uint(1000));
        // platform->getEvents(1);
